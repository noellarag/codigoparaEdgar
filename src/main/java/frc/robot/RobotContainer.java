...
import frc.robot.Commands.InstantCommands.PassCmd;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("TakeCmd", new TakeCmd(m_intake));
    NamedCommands.registerCommand("PassCmd", new PassCmd(m_shooter));
    NamedCommands.registerCommand("ShootCmd", new ShootCmd(m_shooter));
    autoChooser.addOption("3m Auto", new PathPlannerAuto("3mAuto"));
    autoChooser.addOption("Auto Path", new PathPlannerAuto("AutoPath"));
    autoChooser.addOption("2m Auto", new PathPlannerAuto("2mAuto"));
    autoChooser.addOption(("1m Auto New "), new PathPlannerAuto("1mAuto"));
