...
public class DrivetrainSub extends SubsystemBase {
  ...
  public DrivetrainSub() {
    ...
    AutoBuilder.configureRamsete(this::getPose, this::resetOdometry, this::getChassisSpeeds,this::driveRobotRelative, 
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Chassis speeds", getChassisSpeeds().vxMetersPerSecond);
  ...
  public void drive(double speed, double rotation) {
    ...
    ChassisSpeeds chassisSpeeds = new ChassisSpeeds(speed * linearVelocity, 0.0, rotation * angularVelocity);
  ...
  public void driveRobotRelative(ChassisSpeeds speeds) {
    driveTeleop(speeds.vxMetersPerSecond, -speeds.omegaRadiansPerSecond);
  }
